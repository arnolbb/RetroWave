...
import type { GameState, Invader, Bullet, Particle, PowerUp, UFO, Boss, ScorePopup } from '../game/types';
    ...
    <div className="flex min-h-0 flex-col items-center gap-2 w-full">
      ...
      <div className="arcade-panel flex h-11 shrink-0 justify-between w-full font-mono text-neon-blue uppercase tracking-normal text-xs md:text-sm px-3 py-2"
        ...
        <div className="flex items-center gap-2">
          ...
          <motion.span
            key={score}
            initial={{ scale: 1.3, color: COLORS.neonGreen }}
            animate={{ scale: 1, color: COLORS.neonBlue }}
        ...
        <div className="flex items-center gap-2 text-neon-pink">
          <Trophy className="w-3.5 h-3.5 md:w-4.5 md:h-4.5 animate-pulse text-neon-yellow" />
